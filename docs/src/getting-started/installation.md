...
Use the pre‑built archives published on GitHub releases. The example below downloads version `v0.4.2` for your platform and moves the binary into `/usr/local/bin`:

```bash
curl -L https://github.com/mergewayhq/mergeway-cli/releases/download/v0.4.2/mergeway-cli-\
...
```
Mergeway CLI v0.4.2 (commit abc1234)
```
